...
<a class="btn btn-primary" href="${pageContext.request.contextPath}/archiveStages" role="button" onclick="return confirm('Êtes vous sur de vouloir archiver les stages ?')">Archiver les stages</a>
