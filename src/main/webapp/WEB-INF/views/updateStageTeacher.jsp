...
<form:form method="POST" modelAttribute="stageForm" class="form-signin">
	...
	<spring:bind path="administrator">
		<div class="form-group ${status.error ? 'has-error' : ''}">
			<form:input type="text" path="administrator" class="form-control"
				placeholder="Gestionnaire" autofocus="true"></form:input>
			<form:errors path="administrator"></form:errors>
		</div>
	</spring:bind>
		<spring:bind path="validated">
		<div class="form-group ${status.error ? 'has-error' : ''}">
			<label for=validated>Validation </label>
			<form:select type="text" path="validated" class="form-control"
				autofocus="true">
				<option value="Validée par un gestionnaire de conventions">Validée</option>
				<option value="En cours d'édition">En cours d'édition</option>
			</form:select>
			<form:errors path="validated"></form:errors>
		</div>
	</spring:bind>
